...
public class InputModel
{
    ...
    public static explicit operator InputModel(byte[] input)
    {
        ...
        if (input.Length != 4) throw new ArgumentException(ExceptionsResource.InputArrayInvalidLength, nameof(input));
    ...
    public static explicit operator byte[]([NotNull] InputModel input)
    {
        ...
        // Buttons are reversed because BitConverter reverses order due to being little-endien
        return [buttons[1], buttons[0], x, y];
    }
}